...
class LiveaboardPage extends Model
{
    ...
    public static function current(): self
    {
        return static::firstOrCreate([], [
            ...
            'body' => 'Whether you are planning a diving escape, a family adventure or a special celebration on the water, Atolliva Maldives can help you choose the right liveaboard, shape the right route and organise the details that make the experience feel effortless from beginning to end.',
