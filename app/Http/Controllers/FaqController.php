    ...
    public function __invoke(SeoManager $seoManager): View
    {
        ...
        return view('faq', [
            ...
            'seo' => $seoManager->forSimplePage(
                title: $isArabic ? 'الأسئلة الشائعة عن المالديف | أتوليفا المالديف' : 'Maldives FAQ | Atolliva Maldives Travel Questions',
                description: $isArabic ? 'إجابات عن السفر إلى المالديف: الطيران والتنقلات والتأشيرات والطقس والمنتجعات ورحلات القوارب والتخطيط مع أتوليفا المالديف.' : 'Find answers to common Maldives travel questions about transfers, weather, visas, resorts, liveaboards, budgets, honeymoons, and planning with Atolliva Maldives.',
                canonical: route($isArabic ? 'arabic.faq' : 'faq'),
                breadcrumbs: [
                    ['name' => $isArabic ? 'الرئيسية' : 'Home', 'url' => route($isArabic ? 'arabic.home' : 'home')],
                    ['name' => $isArabic ? 'الأسئلة الشائعة' : 'FAQ', 'url' => route($isArabic ? 'arabic.faq' : 'faq')],
                ],
                extraSchema: [[
            ...
            'alternateLanguages' => $isArabic
                ? ['en' => route('faq'), 'x-default' => route('faq')]
                : ['ar' => route('arabic.faq'), 'x-default' => route('faq')],
        ]);
    }

    /** @return array<int, array{title: string, intro: string, items: array<int, array{question: string, answer: array<int, string>}>}> */
    protected function arabicSections(): array
    {
        return [
            [
                'title' => 'أسئلة السفر إلى المالديف',
                'intro' => 'إجابات واضحة عن الوصول إلى المالديف والتنقل بين الجزر والطقس وما يمكن توقعه قبل السفر.',
                'items' => [
                    ['question' => 'أين تقع جزر المالديف؟', 'answer' => ['المالديف دولة جزرية استوائية في المحيط الهندي، إلى الجنوب الغربي من الهند وسريلانكا.', 'تتكون من نحو 1,200 جزيرة مرجانية موزعة على سلاسل من الجزر المرجانية الخلابة.']],
                    ['question' => 'كيف أصل إلى المالديف؟', 'answer' => ['يصل معظم الزوار الدوليين جواً إلى مطار فيلانا الدولي بالقرب من مدينة ماليه.', 'بعد الوصول، يتحدد انتقالك إلى المنتجع أو الجزيرة بواسطة قارب سريع أو طائرة مائية أو رحلة داخلية بحسب الوجهة.']],
                    ['question' => 'كيف أتنقل بين جزر المالديف؟', 'answer' => ['تشمل وسائل التنقل القوارب السريعة والطائرات المائية والرحلات الداخلية والعبّارات العامة والقوارب الخاصة.', 'تساعدك أتوليفا المالديف على اختيار وتنظيم وسيلة النقل الأنسب مع الإقامة.']],
                    ['question' => 'ما أفضل وقت لزيارة المالديف؟', 'answer' => ['يمكن زيارة المالديف طوال العام. ويعد نوفمبر إلى أبريل غالباً الموسم الأكثر جفافاً والأعلى طلباً.', 'من مايو إلى أكتوبر قد تزداد فرص الأمطار والرياح، لكنه وقت جيد أحياناً للعروض والأسعار الأفضل.']],
                    ['question' => 'ما المنطقة الزمنية في المالديف؟', 'answer' => ['تعمل المالديف على توقيت UTC/GMT +5.', 'بعض المنتجعات تعتمد وقتاً خاصاً بالجزيرة لإتاحة ساعات أطول من ضوء النهار للضيوف.']],
                    ['question' => 'كيف يكون الطقس في المالديف؟', 'answer' => ['الطقس استوائي ودافئ على مدار السنة، وتبلغ درجات الحرارة نهاراً عادة نحو 30 درجة مئوية.', 'حتى في الأشهر الأكثر مطراً، تكون الأمطار غالباً على شكل زخات استوائية قصيرة.']],
                    ['question' => 'هل أحتاج إلى تأشيرة لزيارة المالديف؟', 'answer' => ['لا يحتاج السائح عادة إلى استخراج تأشيرة مسبقاً؛ تمنح الإقامة السياحية عند الوصول وفق متطلبات الهجرة في المالديف.', 'تحقق دائماً قبل السفر من صلاحية جواز السفر وحجوزات الإقامة وتذكرة العودة وأحدث متطلبات الدخول.']],
                    ['question' => 'ما هي جزيرة المنتجع في المالديف؟', 'answer' => ['تشتهر المالديف بمفهوم جزيرة واحدة ومنتجع واحد؛ فكثير من المنتجعات تشغل جزيرة خاصة بها.', 'تجد على الجزيرة الشواطئ والبحيرات والمطاعم والأنشطة والإقامة، من فلل الشاطئ إلى الفلل فوق الماء.']],
                    ['question' => 'ما عملة المالديف؟', 'answer' => ['العملة المحلية هي الروفيّا المالديفية (MVR)، كما يقبل الدولار الأمريكي على نطاق واسع في القطاع السياحي، خصوصاً في المنتجعات.', 'قد تتغير أسعار الصرف، لذا يفضل التحقق من السعر الحالي قبل السفر.']],
                    ['question' => 'هل بطاقات الائتمان مقبولة؟', 'answer' => ['نعم، تقبل معظم المنتجعات والفنادق والمطاعم والأنشطة السياحية بطاقات الائتمان والخصم الرئيسية.', 'قد يكون حمل مبلغ نقدي مفيداً في الجزر المحلية والمقاهي والمتاجر الصغيرة.']],
                    ['question' => 'هل المالديف آمنة للسياح؟', 'answer' => ['تعد المالديف عموماً وجهة آمنة للمسافرين الدوليين.', 'اتبع الاحتياطات المعتادة، واحفظ مقتنياتك الثمينة، والتزم بالقوانين المحلية وتعليمات السلامة في المنتجع.']],
                    ['question' => 'ماذا أرتدي في المالديف؟', 'answer' => ['الملابس الخفيفة والمريحة مناسبة للمناخ الاستوائي. وفي جزر المنتجعات، تكون ملابس الشاطئ والمنتجع مقبولة عادة.', 'عند زيارة الجزر المحلية أو ماليه، يرجى احترام الثقافة المحلية بارتداء ملابس محتشمة، واستخدام ملابس السباحة في الأماكن المخصصة لها فقط.']],
                ],
            ],
            [
                'title' => 'عن أتوليفا المالديف',
                'intro' => 'تعرف على خدمات أتوليفا المالديف وكيف نساعدك على اختيار الإقامة والتنقلات وتجربة العطلة المناسبة لك.',
                'items' => [
                    ['question' => 'ما هي أتوليفا المالديف؟', 'answer' => ['أتوليفا المالديف شركة سفر متخصصة في المالديف، تساعد المسافرين على اكتشاف وحجز عطلات جزرية لا تنسى.', 'نساعدك في العثور على المنتجعات وبيوت الضيافة ورحلات القوارب والتنقلات والتجارب المناسبة لاهتماماتك وميزانيتك.']],
                    ['question' => 'ما الخدمات التي تقدمها أتوليفا المالديف؟', 'answer' => ['نساعد في حجوزات المنتجعات وبيوت الضيافة، وباقات شهر العسل والعطلات العائلية، ورحلات القوارب، والتنقلات بالقارب السريع والطائرة المائية والطائرات الداخلية.', 'كما نرتب التجارب والرحلات والبرامج المصممة وفق احتياجاتك.']],
                    ['question' => 'هل يمكنكم مساعدتي في اختيار منتجع؟', 'answer' => ['نعم. أخبرنا بتواريخ السفر وعدد المسافرين والميزانية ونوع الفيلا ونظام الوجبات والأنشطة التي تهمك.', 'سنساعدك في وضع قائمة مختصرة من المنتجعات التي تناسب متطلباتك.']],
                    ['question' => 'هل ترتبون رحلات شهر العسل؟', 'answer' => ['نعم. يمكننا المساعدة في ترتيب منتجعات رومانسية وفلل فوق الماء وفلل بمسبح خاص ومزايا شهر العسل والعشاء الخاص والسبا والتنقلات.']],
                    ['question' => 'هل تناسب خدماتكم العائلات؟', 'answer' => ['بالتأكيد. نوصي بمنتجعات وبيوت ضيافة مناسبة للعائلات بحسب أعمار الأطفال وطبيعة العطلة.', 'ويمكننا تحديد الخيارات التي توفر نوادي أطفال وفلل عائلية ومسابح وأنشطة مناسبة.']],
                    ['question' => 'هل يمكن ترتيب عطلة اقتصادية في المالديف؟', 'answer' => ['نعم. لا تعني عطلة المالديف دائماً منتجعاً فاخراً مرتفع التكلفة.', 'يمكننا مساعدتك في استكشاف بيوت الضيافة في الجزر المحلية والمنتجعات ذات القيمة الجيدة والعروض وخيارات النقل الاقتصادية.']],
                    ['question' => 'هل تقدمون عطلات فاخرة؟', 'answer' => ['نعم. للمسافرين الذين يبحثون عن تجربة استثنائية، نرتب خيارات تشمل فلل فاخرة فوق الماء ومسابح خاصة ومنتجعات راقية وتنقلات وتجارب خاصة.']],
                    ['question' => 'هل يمكنني حجز رحلة قارب للغوص أو المغامرة؟', 'answer' => ['نعم. تعد رحلات القوارب وسيلة رائعة لاكتشاف مناطق مختلفة من المالديف، خصوصاً للغوص والسنوركلينغ وركوب الأمواج والمغامرات البحرية.', 'نساعدك في استكشاف الخيارات المتاحة بحسب تواريخ سفرك واهتماماتك.']],
                    ['question' => 'هل ترتبون انتقالات المطار؟', 'answer' => ['نعم. قد تشمل التنقلات القارب السريع أو الطائرة المائية أو الرحلة الداخلية أو مزيجاً منها بحسب موقع الإقامة.', 'ننسق وسيلة النقل المطلوبة كجزء من ترتيبات حجزك.']],
                    ['question' => 'هل تناسب أتوليفا المالديف الزائر لأول مرة؟', 'answer' => ['نعم، وهنا تكون المعرفة المحلية مفيدة للغاية.', 'نشرح لك الفرق بين المنتجع والجزيرة المحلية، وفيلا الشاطئ وفيلا الماء، وأنظمة الوجبات وأنواع النقل وأفضل فترات السفر.']],
                    ['question' => 'هل يمكنكم تخصيص عطلتي؟', 'answer' => ['نعم. بدلاً من تقديم باقة واحدة للجميع، نصمم توصيات تناسب ميزانيتك وتواريخك واهتماماتك وأسلوب المنتجع والفيلا والأنشطة والمناسبات الخاصة.']],
                    ['question' => 'هل تنظمون رحلات للمجموعات؟', 'answer' => ['نعم. يمكننا المساعدة في عطلات العائلات ومجموعات الأصدقاء والمجموعات المؤسسية وحفلات الزفاف ومجموعات الغوص والرحلات الاحتفالية.']],
                    ['question' => 'هل تقدمون الدعم أثناء العطلة؟', 'answer' => ['نعم. هدفنا ليس إجراء الحجز ثم الاختفاء.', 'نساعدك في ترتيبات السفر قبل الوصول، ونبقى متاحين للمساعدة في الأمور المتعلقة بالحجز أثناء عطلتك.']],
                    ['question' => 'لماذا أحجز عبر أتوليفا المالديف بدلاً من الحجز بنفسي؟', 'answer' => ['مواقع الحجز مفيدة، لكن اختيارك في المالديف يؤثر في نوع النقل وتكلفة الوجبات والأنشطة وتجربة الفيلا والميزانية الإجمالية.', 'نقدم مساعدة بشرية متخصصة في المالديف لمساعدتك على اتخاذ قرار أوضح.']],
                    ['question' => 'كيف أطلب عرض سعر لعطلة في المالديف؟', 'answer' => ['أرسل لنا تواريخ السفر وعدد البالغين والأطفال وأعمارهم والميزانية التقريبية ونمط الإقامة الذي تفضله وأي طلبات خاصة.', 'سنقترح عليك خيارات مناسبة ومتاحة.']],
                    ['question' => 'كيف أتواصل مع أتوليفا المالديف؟', 'answer' => ['يمكنك التواصل معنا عبر نموذج الاستفسار في الموقع أو واتساب أو البريد الإلكتروني.', 'أخبرنا بنوع عطلة المالديف التي تتخيلها وسنساعدك على استكشاف الخيارات المناسبة.']],
                ],
            ],
        ];
    }
