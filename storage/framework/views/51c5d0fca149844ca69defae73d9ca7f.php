...
<section aria-labelledby="why-book-with-micro-travel" class="why-book">
    <div class="why-book__inner">
        ...
        <div class="why-book__grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    ...
                    <div class="why-book__icon" aria-hidden="true">
                        <?php echo e(svg($benefit['icon'], 'why-book__icon-svg')); ?>
                    </div>
...
<?php /**PATH /Users/munad/Documents/Micro Travel/Micro-Travel-Laravel/resources/views/components/why-book-with-micro-travel.blade.php ENDPATH**/ ?>